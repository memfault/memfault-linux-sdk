...
SRC_URI_append = "${@bb.utils.contains('MEMFAULT_DELTA_OTA','1',' file://delta.cfg file://0001-delta_downloader-open-the-channel-once-for-all-reque.patch file://0002-zchunk_range-coalesce-adjacent-chunks-up-to-max-rang.patch','',d)}"
